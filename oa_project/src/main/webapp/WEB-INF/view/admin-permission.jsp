...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_permission_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限节点</a></span> <span class="r">共有数据：<strong id="total"></strong> 条</span> </div>
...
function showData(roles){
	...
	for(var i = 0;i<roles.length;i++){
		...
		html +="<td>"+role.roeId+"</td>";
		html +="<td>"+role.name+"</td>";
		html +="<td>"+role.remark+"</td>";
		html +="<td class='f-14'>";
		html +="<a title='编辑' href='javascript:;' onclick='admin_permission_edit("+role.roeId+")' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a>";
		html +="<a title='删除' href='javascript:;' onclick='admin_permission_del("+role.roeId+")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6e2;</i></a>";
		html +="</td>";
		html +="</tr>";
...
function admin_permission_add(){
	layer_show("添加角色","${ctx}/role/roleadd.do","800","600");
}
/*管理员-权限-编辑*/
function admin_permission_edit(id){
	layer_show("编辑用户","${ctx}/role/edit.do?id="+id,"800","600");
}
...
function admin_permission_del(id){
	layer.confirm('确认要删除吗？',function(index){
		...
		window.menulists("${ctx}/role/list.do",1);
	});
}
